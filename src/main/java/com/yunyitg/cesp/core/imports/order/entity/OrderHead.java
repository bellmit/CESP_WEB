...
public class OrderHead {
    ...
    /**
     * 申报状态(0-未申报；1-待申报；2-已申报；3-发送失败；4-接受成功；5-接受失败;6-申报成功；7-申报失败)
     */
	...
	@Transient
    private List<OrderDetail> orderContent;
     ...
     * 获取关联订单详情id集合
     *
     * @return order_detail_ids - 关联订单详情id集合
     */
     ...
     * 设置关联订单详情id集合
     *
     * @param orderDetailIds 关联订单详情id集合
     */
	...
	public List<OrderDetail> getOrderContent() {
		return orderContent;
	}
    
    public void setOrderContent(List<OrderDetail> orderContent) {
