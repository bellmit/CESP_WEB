...
public class WaybillHead {
     ...
     * 关联运单详情id集合
     */
    @Column(name = "waybill_detail_ids")
    ...
    @Transient
    private List<WaybillDetail> waybillList;
     ...
     * 获取关联运单详情id集合
     *
     * @return waybill_detail_ids - 关联运单详情id集合
     */
     ...
     * 设置关联运单详情id集合
     *
     * @param waybillDetailIds 关联运单详情id集合
     */
    public void setWaybillDetailIds(String waybillDetailIds) {
        this.waybillDetailIds = waybillDetailIds;
    }
    ...
    public List<WaybillDetail> getWaybillList() {
		return waybillList;
	}
    
    public void setWaybillList(List<WaybillDetail> waybillList) {
